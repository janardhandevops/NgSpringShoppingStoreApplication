...
//        NgSpringShoppingStoreApplication ngSpringShoppingStoreApplication=new NgSpringShoppingStoreApplication();
//        SpringApplicationBuilder springApplicationBuilder=new SpringApplicationBuilder(Object.class);
//        assertSame(springApplicationBuilder,ngSpringShoppingStoreApplication.config)
        NgSpringShoppingStoreApplication.main(new String[]{"Test Processing"});
