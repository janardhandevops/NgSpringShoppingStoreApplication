...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse> updateUser(@Valid @RequestBody RegisterRequestDto registerRequestDto, @PathVariable("userId") String userId) {
//        if (!registerRequestDto.getUsername().equals(null)) {
        return new ResponseEntity<ApiResponse>(authService.updateUser(registerRequestDto, userId),HttpStatus.FOUND);
    }
}
